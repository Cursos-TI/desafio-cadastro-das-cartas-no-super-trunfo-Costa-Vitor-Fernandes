...
void ExibirCarta(struct Carta carta1,
    struct Carta carta2){
    printf("Carta1:\n");
    printf("NOME : %s,\n ESTADO: %s,\n CODIGO DA CARTA: %s,\n PIB: %f,\n AREA: %f,\n POPULAÇÃO: %d,\n PONTOS TURISTICOS: %d\n", carta1.nome_cidade, carta1.estado, carta1.codigo_carta, carta1.pib, carta1.area, carta1.populacao, carta1.n_pontos_turisticos);
    printf("\n\n\n\n\n Carta2:\n");
    printf("NOME : %s,\n ESTADO: %s,\n CODIGO DA CARTA: %s,\n PIB: %f,\n AREA: %f,\n POPULAÇÃO: %d,\n PONTOS TURISTICOS: %d\n", carta2.nome_cidade, carta2.estado, carta2.codigo_carta, carta2.pib, carta2.area, carta2.populacao, carta2.n_pontos_turisticos);
};
void Cadastro(struct Carta *carta, int i){
    ...
    printf("NOME : %s,\n ESTADO: %s,\n CODIGO DA CARTA: %s,\n PIB: %f,\n AREA: %f,\n POPULAÇÃO: %d,\n PONTOS TURISTICOS: %d\n \n\n\n\n", carta->nome_cidade, carta->estado, carta->codigo_carta, carta->pib, carta->area, carta->populacao, carta->n_pontos_turisticos);
}
int main() {
